goog.provide('plugin.ogcapi.XYZLayerConfig');
 ...
 * @constructor
 */
plugin.ogcapi.XYZLayerConfig = function() {
  plugin.ogcapi.XYZLayerConfig.base(this, 'constructor');
};
goog.inherits(plugin.ogcapi.XYZLayerConfig, os.layer.config.AbstractTileLayerConfig);

plugin.ogcapi.XYZLayerConfig.ID = "ogcapi-xyz";

/**
 * @inheritDoc
 */
plugin.ogcapi.XYZLayerConfig.prototype.getSource = function(options) {
  ...
  return new plugin.ogcapi.TileSource(/** @type {olx.source.XYZOptions} */ (options));
};